#ifndef WIDGET_EDITOR_PROPIEDADES_MEJORA_VELOCIDAD_H
#define WIDGET_EDITOR_PROPIEDADES_MEJORA_VELOCIDAD_H
...
class Widget_editor_propiedades_mejora_velocidad: 
	public Widget_editor_interface
{
	public:

	Widget_editor_propiedades_mejora_velocidad(const DLibV::Fuente_TTF&, Mejora_velocidad&);
