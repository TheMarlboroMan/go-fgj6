#ifndef WIDGET_EDITOR_PROPIEDADES_AYUDA_H
#define WIDGET_EDITOR_PROPIEDADES_AYUDA_H
...
class Widget_editor_propiedades_ayuda: 
	public Widget_editor_interface
{
	public:

	Widget_editor_propiedades_ayuda(const DLibV::Fuente_TTF&, Ayuda&);
